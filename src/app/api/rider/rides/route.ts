// ============================================================
// GET /api/rider/rides - Rider's Received Tickets
// ============================================================
// Returns rides/tickets assigned to the logged-in rider.
...
export async function GET(req: NextRequest) {
  ...
  try {
    // Get all rides where this user is the assigned rider
    ...
    console.error("Rider tickets error:", error);
